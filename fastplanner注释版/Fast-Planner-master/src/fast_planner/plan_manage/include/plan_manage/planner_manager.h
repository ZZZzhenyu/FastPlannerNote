...
public:
  ...
  EDTEnvironment::Ptr edt_environment_;//edt环境智能指针

private:
  /* main planning algorithms & modules */
  SDFMap::Ptr sdf_map_;//sdf地图智能指针
//前端路径搜索智能指针
  unique_ptr<Astar> geo_path_finder_;
  unique_ptr<KinodynamicAstar> kino_path_finder_;
  unique_ptr<TopologyPRM> topo_prm_;
  vector<BsplineOptimizer::Ptr> bspline_optimizers_;//后端bspline智能指针
...
public:
  typedef unique_ptr<FastPlannerManager> Ptr;//整个类的智能指针
